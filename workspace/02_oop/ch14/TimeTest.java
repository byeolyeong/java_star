...
public class TimeTest {
    public static void main(String[] args) {
        ...
        System.out.println("시: " + now.getHour()); // today. 에는 시간을 꺼내는 메서드가 없음
        ...
        // 5. 부트캠프의 시작일 2026.05.14입니다.
        // 수료일은 2026.11.16 입니다.
        // 오늘은 부트캠프 시작일로부터 몇 일이 지났는지 출력하세요.
        // 앞으로 몇 일이 지나면 수료를 하는지 출력하세요.
        // 그리고 총 수업 기간이 몇일인지 출력하세요.
