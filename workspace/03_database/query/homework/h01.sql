...
INSERT INTO post (member_id, title, content, created_at)  VALUES (4, '여섯 번째 게시글', '데이터베이스 기초.', '2026-06-11 09:31:14');
INSERT INTO post (member_id, title, content, created_at)  VALUES (3, '일곱 번째 게시글', 'Java 프로그래밍 기초.', '2026-05-20 11:20:59');
INSERT INTO post (member_id, title, content, created_at)  VALUES (1, '여덟 번째 게시글', '연산자, if문, if-else문', '2026-05-21 10:13:58');
INSERT INTO post (member_id, title, content, created_at)  VALUES (2, '아홉 번째 게시글', 'if, if-else문 복습.', '2026-05-24 09:08:04');
INSERT INTO post (member_id, title, content, created_at)  VALUES (1, '열 번째 게시글', 'switch문, while문, for문', '2026-05-24 10:21:54');

INSERT INTO post (member_id, title, content, created_at)  VALUES (2, '열 한 번째 게시글', '배열 선언, 생성, 초기화', '2026-05-27 11:11:11');
INSERT INTO post (member_id, title, content, created_at)  VALUES (2, '열 두 번째 게시글', '다차원 배열, 강화된 for문', '2026-05-28 13:33:26');
INSERT INTO post (member_id, title, content, created_at)  VALUES (3, '열 세 번째 게시글', '배열의 복사, Arrays 클래스', '2026-05-29 10:13:20');
INSERT INTO post (member_id, title, content, created_at)  VALUES (1, '열 넷 번째 게시글', '메서드 선언과 호출, main 메소드', '2026-06-01 13:11:44');
INSERT INTO post (member_id, title, content, created_at)  VALUES (5, '열 다섯 번째 게시글', '명령행 매개변수, 메서드 오버로딩', '2026-06-02 10:21:09');

INSERT INTO post (member_id, title, content, created_at)  VALUES (5, '열 여섯 번째 게시글', '객체지향 프로그래밍(OOP) 기초', '2026-06-03 09:15:16');
INSERT INTO post (member_id, title, content, created_at)  VALUES (4, '열 일곱 번째 게시글', '상속, 메서드 오버라이딩, Object 클래스', '2026-06-04 13:21:15');
INSERT INTO post (member_id, title, content, created_at)  VALUES (4, '열 여덟 번째 게시글', '다형성, 추상클래스, 인터페이스', '2026-06-08 09:33:48');
INSERT INTO post (member_id, title, content, created_at)  VALUES (4, '열 아홉 번째 게시글', 'String 클래스, Wrapper 클래스, Math 클래스', '2026-06-09 14:21:30');
INSERT INTO post (member_id, title, content, created_at)  VALUES (2, '스무 번째 게시글', 'Math 클래스, Scanner 클래스, Random 클래스', '2026-06-09 15:01:54');
...
select member_id , title, created_at
	from post
	order by member_id desc, title desc, created_at desc
